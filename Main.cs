    ...
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            */
            ...
            g.AddVertexAndOutgoingEdges('A', new Dictionary<char, int>() { { 'E', 1 }, { 'B', 3 } });
            g.AddVertexAndOutgoingEdges('B', new Dictionary<char, int>() { { 'C', 1 } });
            g.AddVertexAndOutgoingEdges('C', new Dictionary<char, int>() { { 'H', 1 }, { 'E', 1 }, { 'D', 1 } });
            g.AddVertexAndOutgoingEdges('D', new Dictionary<char, int>() { { 'E', 3 }, { 'C', 1 } });
            g.AddVertexAndOutgoingEdges('E', new Dictionary<char, int>() { { 'A', 1 }, { 'F', 2 } });
            g.AddVertexAndOutgoingEdges('F', new Dictionary<char, int>() { { 'G', 3 } });
            g.AddVertexAndOutgoingEdges('G', new Dictionary<char, int>() { { 'F', 3 }, { 'J', 1 } });
            g.AddVertexAndOutgoingEdges('H', new Dictionary<char, int>() { { 'C', 1 }, { 'G', 1 }, { 'I', 2 } });
            g.AddVertexAndOutgoingEdges('I', new Dictionary<char, int>() { { 'H', 2 }, { 'L', 1 } });
            g.AddVertexAndOutgoingEdges('J', new Dictionary<char, int>() { { 'G', 1 }, { 'K', 2 } });
            g.AddVertexAndOutgoingEdges('K', new Dictionary<char, int>() { { 'J', 2 }, { 'M', 1 } });
            g.AddVertexAndOutgoingEdges('L', new Dictionary<char, int>() { { 'I', 1 }, { 'M', 3 } });
            g.AddVertexAndOutgoingEdges('M', new Dictionary<char, int>() { { 'K', 1 }, { 'L', 3 } });
